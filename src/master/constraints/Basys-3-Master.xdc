...
set_property -dict { PACKAGE_PIN M1   IOSTANDARD LVCMOS33 } [get_ports {Mscale_scl}];#Sch name = XA3_N
set_property -dict { PACKAGE_PIN N1   IOSTANDARD LVCMOS33 } [get_ports {Mscale_sda}];#Sch name = XA4_N
